...
#### Несколько слов о стойкости алгоритма к перебору

__Это не криптостойкий алгоритм!!!__
Хорошие алгоритмы в большинстве своем строятся на случайных числах. В приведенном алгоритме нет случайностей. Он сделан для того, чтобы можно было легко расшифровать фразу зная пин-код!
Вам не следует хранить зашифрованную им фразу в местах, доступ в которые неограничен и незащищен.

Пусть вас не впечатляет количество возможных вариантов фраз, которые можно составить из готового тумана (12 слов в тумане из 120 слов).
$C12120=120!12!⋅(120−12)! =  10 542 859 559 688 820$

Если перебирать возможные ключи, то вариантов будет _всего_ 1 000 000 000 000 (один триллион).
